        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable get order_products ".concat(id, ": ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    Order_productsStore.prototype.create = function (products) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable create order_products ".concat(products.order_id, ": ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    Order_productsStore.prototype.destroy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("unable delete order_products ".concat(id, ": ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
