            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        throw new Error("unable get Order: ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable get Order ".concat(id));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.create = function (orders) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [orders.status, orders.user_id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        if (result.rowCount) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable create Order ".concat(orders.id, ": ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
